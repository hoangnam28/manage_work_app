...
const ImportMaterialNewModal = ({ open, onCancel, onSuccess, loadData }) => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await axios.post('/material-new/import-material-new', { data }, {
  ...
  return (
    <Modal
      title="Import Material New từ Excel (Review)"
      open={open}
...
export default ImportMaterialNewModal; 