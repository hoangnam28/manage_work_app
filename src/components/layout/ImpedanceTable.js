...
const ImpedanceTable = ({ data, onDataChange, onEdit, onSoftDelete }) => {
  ...
  const columns = [
    ...
    ...(onEdit && onSoftDelete ? [{
      title: renderColumnTitle('Thao tác'),
      key: 'action',
      fixed: 'left',
      width: 120,
      align: 'center',
    ...
    {
      title: renderColumnTitle('JobName'),
      dataIndex: 'IMP_1',
      key: 'imp_1',
      align: 'center',
      fixed: 'left',
    ...
    },
    {
      ...
      children: [
        {
          title: renderColumnTitle('Đồng'),
          children: [
            {
              title: renderColumnTitle('Lá đồng (µm)'),
              dataIndex: 'IMP_15',
              key: 'imp_15',
              width: 100,
              align: 'center',
        ...
        },
        {
          ...
          children: [
            {
              title: renderColumnTitle('Mắt lưới'),
              dataIndex: 'IMP_19',
              key: 'imp_19',
              width: 100,
              align: 'center',
    ...
    {
      title: renderColumnTitle('Thông tin IMP yêu cầu của khách hàng'),
      children: [
        {
          title: renderColumnTitle('Giá trị IMP'),
          dataIndex: 'IMP_25',
          key: 'imp_25',
          width: 100,
          align: 'center',
    ...
    {
      title: renderColumnTitle('Tổng hợp kết quả mô phỏng'),
      children: [
        {
          title: renderColumnTitle('Giá trị IMP'),
          dataIndex: 'IMP_36',
        ...
        {
          title: renderColumnTitle('Độ dày đồng (µm)'),
          dataIndex: 'IMP_41',
          key: 'imp_41',
          width: 100,
          align: 'center',
        ...
        },
        {
          ...
          children: [
            {
              title: renderColumnTitle('Đỉnh đường mạch'),
              dataIndex: 'IMP_48',
              key: 'imp_48',
              width: 100,
              align: 'center',
    ...
    {
      title: renderColumnTitle('Tổng hợp kết quả đo thực tế'),
      children: [
        {
          title: renderColumnTitle('Giá trị IMP'),
          children: [
            {
              title: renderColumnTitle('No 1'),
              dataIndex: 'IMP_52',
              key: 'imp_52',
              width: 100,
              align: 'center',
        ...
        {
          title: renderColumnTitle('Độ dày đồng'),
          children: [
            {
              title: renderColumnTitle('No 1'),
              dataIndex: 'IMP_78',
        ...
        },
        {
          ...
          children: [
            {
              title: renderColumnTitle('Độ dày PP'),
              children: [
                {
                  title: renderColumnTitle('No 1'),
                  dataIndex: 'IMP_84',
    ...
    {
      title: renderColumnTitle('So sánh kết quả giữ mô phỏng và thực tế'),
      children: [
        {
          title: renderColumnTitle('Giá trị IMP'),
          dataIndex: 'IMP_122',
