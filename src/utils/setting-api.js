...
export const settingApi = {
  ...
  // ============================================
  // APIs ĐỂ SỬ DỤNG KHI TẠO MỚI
  // ============================================

  /**
   * Lấy danh sách Business Templates đang active (cho dropdown)
   */
  getActiveBusinessTemplates: async () => {
    try {
      const response = await axios.get('/settings/business-templates/active');
      return response.data;
    } catch (error) {
  ...
  /**
   * Lấy danh sách Project Templates đang active theo Business Template
   */
  getActiveProjectTemplates: async (boTemplateId) => {
    try {
      const response = await axios.get(`/settings/project-templates/active/${boTemplateId}`);
      return response.data;
    } catch (error) {
  ...
  /**
   * Lấy danh sách Task Templates đang active theo Project Template
   */
  getActiveTaskTemplates: async (projectTemplateId) => {
    try {
      const response = await axios.get(`/settings/task-templates/active/${projectTemplateId}`);
      return response.data;
    } catch (error) {
  ...
  /**
   * Lấy chi tiết Business Template để auto-fill
   */
  getBusinessTemplateDetails: async (id) => {
    try {
      const response = await axios.get(`/settings/business-templates/${id}/details`);
      return response.data;
    } catch (error) {
      console.error('Error fetching business template details:', error);
      throw error;
    }
  },
};
